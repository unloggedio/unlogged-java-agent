...
//    private final TypeHierarchy typeHierarchy;
     ...
     */
    public Weaver(WeaveConfig config, DataInfoProvider dataInfoProvider) {
...
//        logger.printf("Agent version: %s%n", agentVersion);
     ...
     */
    public InstrumentedClass weave(String container, String className, byte[] target, ClassLoader classLoader) throws IOException {
...
//        try {
        ...
        try {
            classTransformer = new ClassTransformer(weaveLog, config, target, classLoader);
            ...
            if (e.getMessage() != null && e.getMessage().startsWith("Method too large")) {
                ...
                try {
                    ...
                    classTransformer = new ClassTransformer(weaveLog, smallerConfig, target, classLoader);
//                    log("LogLevel.IgnoreArrayInitializer: " + container + "/" + className);
                    ...
                    if (e.getMessage() != null && e.getMessage().startsWith("Method too large")) {
                        ...
                        classTransformer = new ClassTransformer(weaveLog, smallestConfig, target, classLoader);
