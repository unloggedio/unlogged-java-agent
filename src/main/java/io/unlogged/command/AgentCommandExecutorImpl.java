...
//            reactorContextTestExecutionListener.beforeTestMethod(null);
            ...
            try {
                ...
                if (targetClassLoader1 == null) {
                    targetClassLoader1 = targetClassLoader;
                }
                if (objectInstanceByClass == null) {
                ...
                ClassLoader targetClassLoader = objectInstanceByClass != null ?
...
//            exception.printStackTrace();
    ...
    @Override
    public void setClassLoader(ClassLoader targetClassLoader) {
