package com.insidious.agent.weaver.method;

import com.insidious.agent.EventType;
import com.insidious.agent.weaver.WeaveLog;
...
public class MethodTransformer extends LocalVariablesSorter {
	...
	public static final String LOGGER_CLASS = "com/insidious/agent/logging/Logging";
