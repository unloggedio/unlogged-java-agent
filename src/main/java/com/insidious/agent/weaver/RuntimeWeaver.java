...
public class RuntimeWeaver implements ClassFileTransformer {
        ...
        if (outputDir.isDirectory() && outputDir.canWrite()) {
            ...
            if (config.isValid()) {
                ...
                switch (params.getMode()) {
                    ...
                    case Single:
                        AggregatedLogger aggregateLogger = new AggregatedLogger(new FileNameGenerator(new File(params.getOutputDirname()), "log-", ".selog"), weaver);
    ...
    public boolean isExcludedFromLogging(String className) {
        if (className.startsWith("com/insidious/agent/") && !className.startsWith("com/insidious/agent/testdata/"))
            return true;
