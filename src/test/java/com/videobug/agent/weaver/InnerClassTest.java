...
public class InnerClassTest {
	...
	public void setup() throws IOException, ClassNotFoundException {
		...
		wovenClass = loader.loadAndWeaveClass("SimpleTarget$StringComparator");
		ownerClass = loader.loadClassFromResource("SimpleTarget", "com/insidious/agent/testdata/SimpleTarget.class");
	...
	public void testSort() throws IOException, IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
		...
		Assert.assertEquals("com/insidious/agent/testdata/SimpleTarget$StringComparator", it.getClassName());
